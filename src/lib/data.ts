...
export const TEAM_COLORS = [
  ...
  { accent: '#f5a623', glow: '#ffcc60', tint: [245, 166, 35],  label: 'amber'  },
  { accent: '#5dcaa5', glow: '#8fe3c8', tint: [93, 202, 165],  label: 'teal'   },
  { accent: '#e24b4a', glow: '#f09595', tint: [226, 75, 74],   label: 'red'    },
  { accent: '#378add', glow: '#85b7eb', tint: [55, 138, 221],  label: 'blue'   },
]
